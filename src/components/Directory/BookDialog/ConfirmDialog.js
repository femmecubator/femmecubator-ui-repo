...
const ConfirmDialog = ({ openConfirm, handleConfirmClose, handleAwesomeOpen, mentorInfo }) => {
    ...
    return (
        <>
            ...
            <GoogleLogin
                clientId="87984539831-8ucf61ttpkdclgk9r2mpesa9beu6htkr.apps.googleusercontent.com"
                render={renderProps => (
                    <button
            ...
            >
                ...
                <DialogActions className={`${actionButtons} ${paddingTopSm} ${paddingBottomLg}`}>
                    <Button
